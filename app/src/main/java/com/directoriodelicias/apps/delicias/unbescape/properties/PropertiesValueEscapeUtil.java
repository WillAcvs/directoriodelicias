 ...
 * =============================================================================
 */
package com.directoriodelicias.apps.delicias.unbescape.properties;
...
final class PropertiesValueEscapeUtil {
    ...
    /*
     * JAVA PROPERTIES VALUE ESCAPE OPERATIONS
     * ---------------------------------------
     *
     ...
     */
    static String escape(final String text, final PropertiesValueEscapeLevel escapeLevel) {
    ...
    static void escape(final char[] text, final int offset, final int len, final Writer writer,
                       final PropertiesValueEscapeLevel escapeLevel)
            throws IOException {
