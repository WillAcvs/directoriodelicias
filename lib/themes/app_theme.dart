  ...
  static TextTheme _buildTextTheme(TextTheme base) {
    ...
    return base.copyWith(
      ...
      caption: base.caption!
          .copyWith(fontFamily: fontName, color: Color(0xFF17262A)),
      bodyText1: base.bodyText1!
          .copyWith(fontFamily: fontName, color: Color(0xFFF3F3F3)),
      bodyText2: base.bodyText2!
          .copyWith(fontFamily: fontName, color: Color(0xFFEEEEEE)),
      subtitle1: base.subtitle1!
          .copyWith(fontFamily: fontName, color: Colors.black.withOpacity(0.6)),
  ...
  static TextTheme _buildTextDarkTheme(TextTheme base) {
    ...
    return base.copyWith(
      ...
      caption: base.caption?.copyWith(
          fontFamily: fontName, color: Colors.white), // main caption of the app
      bodyText1: base.bodyText1
          ?.copyWith(fontFamily: fontName, color: Color(0xFF202428)),
      bodyText2: base.bodyText2?.copyWith(
          fontFamily: fontName,
          color: Color(0xFF202428)), // background for list entries in home
      subtitle1: base.subtitle1?.copyWith(
          fontFamily: fontName, color: Colors.white.withOpacity(0.8)),
      subtitle2: base.subtitle2
          ?.copyWith(fontFamily: fontName, color: Color(0xFF202428)),
      overline: base.overline?.copyWith(fontFamily: fontName),
    );
