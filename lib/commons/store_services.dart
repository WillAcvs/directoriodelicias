      ...
      builder: (BuildContext context) {
        return FutureBuilder<DataHandler>(
          future: GetIt.instance.get<DataParser>().insertStore(
            ...
            monOpen: monOpen.hour.toString() + ":" + monOpen.minute.toString(), 
            monClose: monClose.hour.toString() + ":" + monClose.minute.toString(), 
            tueOpen: tueOpen.hour.toString() + ":" + tueOpen.minute.toString(), 
            tueClose: tueClose.hour.toString() + ":" + tueClose.minute.toString(), 
            wedOpen: wedOpen.hour.toString() + ":" + wedOpen.minute.toString(), 
            wedClose: wedClose.hour.toString() + ":" + wedClose.minute.toString(), 
            thuOpen: thuOpen.hour.toString() + ":" + thuOpen.minute.toString(), 
            thuClose: thuClose.hour.toString() + ":" + thuClose.minute.toString(), 
            friOpen: friOpen.hour.toString() + ":" + friOpen.minute.toString(), 
            friClose: friClose.hour.toString() + ":" + friClose.minute.toString(), 
            satOpen: satOpen.hour.toString() + ":" + satOpen.minute.toString(), 
            satClose: satClose.hour.toString() + ":" + satClose.minute.toString(), 
            sunOpen: sunOpen.hour.toString() + ":" + sunOpen.minute.toString(), 
            sunClose: sunClose.hour.toString() + ":" + sunClose.minute.toString(), 
