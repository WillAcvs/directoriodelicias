...
class ReviewServices {
  ...
  static void showReview({context, int storeId, loggedUser, Function onSuccessReview}) async {
  ...
  static void syncReview({review, loggedUser, int storeId, context, onSuccessReview}) async {
