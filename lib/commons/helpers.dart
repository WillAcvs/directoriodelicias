...
class Helpers {
  ...
  static YYDialog showAlertDialog({@required context, Function onTapOk, title, message}) {
    ...
    ..text(
      padding: EdgeInsets.only(left:25.0, right: 25.0, bottom: 10.0, top:20.0),
  ...
  static YYDialog showDualButtonDialog({context, Function onTapOk, Function onTapDismiss, title, message}) {
    return YYDialog().build(context)
    ..barrierDismissible = false
    ..barrierColor 
    ..width = MediaQuery.of(context).size.width - 60
  ...
  static YYDialog showRatingDialog({context, Function(double) onTapRate, Function onTapOk}) {
    return YYDialog().build(context)
    ..barrierDismissible = false
    ..barrierColor 
  ...
  static YYDialog showReviewDialog({context, Function(String) onTapReview, Function onTapOk}) { 
  ...
  static Widget createClickableText({text = "00:00 - 23:59", @required context, onTap}) {
    return Padding(
  ...
  static Widget createFormField({controller, placeholder, validatorText, @required context, double height = 50, bool enabled = true}) {
    return Padding(
      padding: const EdgeInsets.only(top: 10, left: 0, right: 0),
      child: Container(
        decoration: BoxDecoration(
  ...
  static Widget createFormFieldClickable({@required didTap, placeholder, @required context}) {
    return Padding(
      padding: const EdgeInsets.only(top: 10, left: 0, right: 0),
      child: Container(
        decoration: BoxDecoration(
  ...
  static Widget createTimeRange({
    ...
    if(startTime != null) {
      formatStartTime = sprintf("%02d:%02d", [startTime.hour, startTime.minute]);
    }
  ...
  static Widget loadCacheImage({imageUrl}) {
    return CachedNetworkImage(
      ...
      errorWidget: (context, url, error) => 
        Image.asset(Helpers.getThemedPhotoPlaceHolder(context), fit: BoxFit.cover),
      imageUrl: imageUrl,
    );
  }
  ...
  static Widget loadCacheImageThumb({imageUrl}) {
    return CachedNetworkImage(
      ...
      errorWidget: (context, url, error) => Image.asset(Config.DEFAULT_THUMB_PHOTO),
      imageUrl: imageUrl,
    );
  }
  ...
  static YYDialog showRadiusDialog({context, Function(String) onTap, Function(String) onTapOk, initialValue}) { 
    TextEditingController controller = new TextEditingController();
  ...
  static String getThemedPhotoPlaceHolder(context) {
    return Helpers.isDarkMode(context) ? 
      Config.DEFAULT_EMPTY_PHOTO_PLACEHOLDER_DARK : Config.DEFAULT_EMPTY_PHOTO_PLACEHOLDER;
  }

  static String getThemedThumbPlaceHolder(context) {
    return Helpers.isDarkMode(context) ? 
      Config.DEFAULT_THUMB_PHOTO_DARK : Config.DEFAULT_THUMB_PHOTO;
  }
  ...
  static YYDialog showLanguageDialog({context, Function(int) onTap, Function onTapOk, initialValue}) { 
    
    List<RadioItem> radioItems = List<RadioItem>();
